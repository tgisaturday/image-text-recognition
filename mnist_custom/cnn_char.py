from mnist_custom import read_data_sets
...
for i in range(100):
    ...
    total_accuracy += sess.run(accuracy, feed_dict={x: batch[0],y_: batch[1], keep_prob: 1.0}))
print("test accuracy %g" %(total_accuracy/100))
